...
domReady( () => {
	let container = document.getElementById( 'woocommerce-square-settings__container-general' );
	...
	if ( container ) {
		...
		container = document.getElementById( 'woocommerce-square-payment-gateway-settings__container--gift_cards_pay' );
		if ( container ) {
			const root = createRoot( container );
