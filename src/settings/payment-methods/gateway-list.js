	...
	const rows = [
		{
			...
			description: __( 'Let your customers pay with major credit and debit cards without leaving your store.', 'woocommerce-square' ),
			customize:   null,
		},
		{
			key:         'digital_wallet',
		...
		},
		{
			...
			description: __( 'Enable customers to check out instantly using their Cash App balance or linked payment methods.', 'woocommerce-square' ),
			customize:   'cash-app',
		},
		{
			key:         'gift_cards',
			...
			description: __( 'Accept Square Gift Cards online or in person, giving customers a convenient way to redeem their balance at checkout.', 'woocommerce-square' ),
			customize:   null,
		},
	];
	...
	return (
		<div className="wc-square-payment-methods-list">
			<p className="wc-square-payment-methods-list__description">
				{ __( 'Select which payment methods you\'d like to offer to your shoppers. You can update these at any time.', 'woocommerce-square' ) }
			</p>
			{ rows.map( ( row ) => (
				<div key={ row.key } className="wc-square-payment-methods-list__row">
					...
					<div className="wc-square-payment-methods-list__row-actions">
						{ row.customize && (
							<Button
								variant="link"
								onClick={ () => setValue( 'payment_methods_view', row.customize ) }
							>
