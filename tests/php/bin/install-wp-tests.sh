#!/usr/bin/env bash
# Installs the WordPress unit-test scaffolding for the Square for WooCommerce
# plugin. Standard WP-CLI installer pattern (no Square-specific behavior).
#
# Usage:
#   bash tests/php/bin/install-wp-tests.sh <db-name> <db-user> <db-pass> [db-host] [wp-version] [skip-database-creation]
