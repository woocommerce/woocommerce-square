<?php
/**
 * Tests for WooCommerce\Square\Internal\Abilities\Domain\GetLocations.
 *
...
use WooCommerce\Square\Internal\Abilities\Domain\GetLocations;

class GetLocationsTest extends WP_UnitTestCase {
	...
	public function test_registration_args_callbacks_are_wired_to_domain_class() {
		$args = GetLocations::get_registration_args();
		$this->assertSame( array( GetLocations::class, 'execute' ), $args['execute_callback'] );
	...
	public function test_ability_is_registered_with_expected_shape() {
		...
		$ability = wp_get_ability( 'woocommerce-square/get-locations' );
