<?php
/**
 * Tests for WooCommerce\Square\Internal\Abilities\Domain\GetCashAppPaymentSettings.
 *
...
use WooCommerce\Square\Internal\Abilities\Domain\GetCashAppPaymentSettings;

class GetCashAppPaymentSettingsTest extends WP_UnitTestCase {
	...
	public function test_registration_args_callbacks_are_wired_to_domain_class() {
		$args = GetCashAppPaymentSettings::get_registration_args();
		$this->assertSame( array( GetCashAppPaymentSettings::class, 'execute' ), $args['execute_callback'] );
	...
	public function test_ability_is_registered_with_expected_shape() {
		...
		$ability = wp_get_ability( 'woocommerce-square/get-cash-app-payment-settings' );
