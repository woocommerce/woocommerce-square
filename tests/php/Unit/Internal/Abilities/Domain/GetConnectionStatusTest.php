<?php
/**
 * Tests for WooCommerce\Square\Internal\Abilities\Domain\GetConnectionStatus.
 *
...
use WooCommerce\Square\Internal\Abilities\Domain\GetConnectionStatus;

class GetConnectionStatusTest extends WP_UnitTestCase {
	...
	public function test_registration_args_callbacks_are_wired_to_domain_class() {
		...
		$this->assertSame( array( GetConnectionStatus::class, 'execute' ), $args['execute_callback'] );
	...
	public function test_ability_is_registered_with_expected_shape() {
		...
		$ability = wp_get_ability( 'woocommerce-square/get-connection-status' );
