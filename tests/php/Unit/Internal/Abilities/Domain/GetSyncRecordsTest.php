<?php
/**
 * Tests for WooCommerce\Square\Internal\Abilities\Domain\GetSyncRecords.
 *
...
use WooCommerce\Square\Internal\Abilities\Domain\GetSyncRecords;

class GetSyncRecordsTest extends WP_UnitTestCase {
	...
	public function test_registration_args_callbacks_are_wired_to_domain_class() {
		$args = GetSyncRecords::get_registration_args();

		$this->assertSame(
			array( GetSyncRecords::class, 'execute' ),
	...
	public function test_ability_is_registered_with_expected_shape() {
		...
		$ability = wp_get_ability( 'woocommerce-square/get-sync-records' );
